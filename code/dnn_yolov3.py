# Link = https://omes-va.com/deteccion-de-objetos-yolov3-dnn-opencv-python/
...
image = cv2.imread("images/ParkingLot/image53.jpg")
image = cv2.imread("images/camera/image7.jpg")
